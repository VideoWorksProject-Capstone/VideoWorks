    ...
    document.querySelector(".login-btn").addEventListener("click", function () {
        ...
        let request = {
            ...
            headers: {
                ...
                'Authorization': 'Basic ' + btoa('videoworks-client:secret')
            },
            body: `grant_type=${obj.grant_type}&username=${obj.username}&password=${obj.password}&client_id=videoworks-client`
        };

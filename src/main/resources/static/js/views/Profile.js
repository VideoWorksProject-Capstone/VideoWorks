    ...
    return `
        ...
        <div class="hero-area">
            ...
            <section class="profile-container">
                <section class="profile-container__sidebar">
                    <img src="/img/3.jpeg" alt="testing" class="sidebar-profile-img">
                    <h2 class="sidebar-username">Some User</h2>
                    <p class="sidebar-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi,
                        sapiente.</p>
                    <p class="sidebar-member-since">Member since Nov 2020</p>
                </section>
                <main class="profile-container__main-area">
                    <nav>
                    ...
                    <div class="profile-services-wrapper">
                        <div class="profile-services-card">
                            <img src="/img/3.jpeg" alt="test2">
                            <p class="service-card-title">Remix 5 Songs</p>
                            <a href="#" class="service-card-button">View Job</a>
                        </div>
                    </div>
                </main>
        </div>
